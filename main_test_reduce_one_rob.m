...
[Start_test,Goal_test,dis_num,ini_dir_rob,ini_x_value,ini_u_value]=reduce_one_rob(Start_test,Goal_test,RobotNum_total,ini_dir_rob,ini_x_value,ini_u_value);
...
tic
 [PathStore_2,Path_num_2,ini_dir_way,ini_dir_rob,ini_x_value,ini_u_value]=IP_solver_single_way_test(D,Start_test,Goal_test,RobotNum_total-1,size_D,ini_dir_way,ini_dir_rob,ini_x_value,ini_u_value);
toc
run_time(2)=toc;
figure(2)
show_graph(D,RobotNum_total-1,PathStore_2)
