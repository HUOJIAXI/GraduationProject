...
%         continue
%     else
        [ini_Path_num,ini_PathStore]=initial_x_way(D_reduit,RobotNum,Start,Goal);
%     end
    ...
    for i = 1:RobotNum
     ...
     [err,PathStore,Path_num,dir_way,runtime_indi]=IP_solver_single_way_V3_res(D_reduit,Start,Goal,RobotNum,size_D,ini_x_value);
%      load dat result
     if err == 1
         continue
     end
