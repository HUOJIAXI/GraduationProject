...
for i = 1:RobotNum_total
    ...
    tic
        ...
        [PathStore,Path_num,ini_dir_way,ini_dir_rob,ini_x_value,ini_u_value]=IP_solver_single_way_ini(D,Start_test,Goal_test,i,size_D,ini_dir_way,ini_x_value);    % 将上一次求解所得ini_dir_way作为原始解输入
